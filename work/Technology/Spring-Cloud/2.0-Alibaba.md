...
常见的全局事务模式：**AT** \ TCC \ SAGA \ XA

二阶段的提交模式（2 Prepare Commit）

1. 各个服务进行预提交，返回给事务管理器状态
2. 事务管理器收到所有服务的状态后，判定是否要进行回滚或者提交

[AT模式详解](https://seata.io/zh-cn/docs/dev/mode/at-mode)

![image](https://img.alicdn.com/tfs/TB19qmhOrY1gK0jSZTEXXXDQVXa-1330-924.png)

**Seata 实现**

![Seata 一阶段](seata-1pc.png)
